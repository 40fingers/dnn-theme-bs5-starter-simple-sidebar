...
<div class="wrap-skin d-flex" id="wrapper">
    ...
    <div class="border-end bg-white" id="sidebar-wrapper">
        ...
        <dnn:MENU MenuStyle="menu/sidemenu" runat="server" ExcludeNodes="Admin,Host"></dnn:MENU>
    </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <dnn:MENU MenuStyle="menu/topmenu" runat="server" ExcludeNodes="Admin,Host"></dnn:MENU>
                </div>
            </div>
        </nav>
        <!-- Page content-->
...
<!-- Bootstrap core JS-->
<dnn:DnnJsInclude runat="server" ForceProvider="DnnFormBottomProvider" FilePath="vendors/bootstrap/dist/js/bootstrap.bundle.min.js" PathNameAlias="SkinPath" />
