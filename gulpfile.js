...
function getVendors(cb){
  ...
  // FontAwesome 5 CSS
  const faCSS = ['node_modules/@fortawesome/fontawesome-free/css/all.css', '_src/theme/_extra/FontAwesome-4-shim/v4-shims.min.css']; // Unfortunately the v4 Shim is not available through npm
...
exports.setup = parallel(getVendors, copyContainers, buildScss);
